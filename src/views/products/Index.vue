                ...
                <div class="sidebar-holder">
                  ...
                  <div class="single-sidebar-box mt-30 wow fadeInUp animated ">
                    ...
                    <div class="checkbox-item">
                      <form>
                        <div class="form-group" v-for="category in filter.categories">
                          <input type="checkbox" :id="category.id" @click="categoryCheck(category.id)">
...
<!--                  </div>-->
                ...
                <button @click.prevent="getFilterProduct()" class="filterbtn" type="submit"> Filter </button>
                    </div>
                  </div>
                      ...
                      <div class="row">
                        <div class="col-xl-4 col-lg-6 col-6 " v-for="product in products">
                          <div class="products-three-single w-100  mt-30">
                            ...
                            <div class="products-three-single-content text-center"> <span>{{ product.category.title
                              }}</span>
