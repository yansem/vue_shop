            ...
            <div class="mobile-menu ">
              ...
              <div class="mobile-menu__sidebar-menu">
                ...
                <ul class="page-dropdown-menu">
                  <li class="dropdown-list"><router-link :to="{ name: 'main.index'}"><span>Home </span></router-link></li>
                  <li
                      class="dropdown-list"><router-link
                      :to="{ name: 'product.index'}"><span>Products </span></router-link></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div class="container ">
                <div class="row">
                  <nav>
                    <ul
                        class="page-dropdown-menu d-flex align-items-center justify-content-center">
                      <li class="dropdown-list"> <router-link
                          :to="{ name: 'main.index'}"><span>Home</span></router-link></li>
                      <li
                          class="dropdown-list"><router-link
                          :to="{ name: 'product.index'}"><span>Products </span></router-link></li>
                    </ul>
      ...
      <div class="side-cart d-flex flex-column justify-content-between">
        ...
        <div class="bottom">
          ...
          <div class="button-box d-flex justify-content-between"> <router-link :to="{name: 'cart.index'}"
                                                                               class="btn_black">View cart</router-link>
          </div>
        </div>
      </div>
